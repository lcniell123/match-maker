...
import { FriendRequest } from "../API.js";
...
export declare type FriendRequestUpdateFormProps = React.PropsWithChildren<
  {
    ...
    onSubmit?: (
      fields: FriendRequestUpdateFormInputValues
    ) => FriendRequestUpdateFormInputValues;
...
>;
export default function FriendRequestUpdateForm(
  props: FriendRequestUpdateFormProps
): React.ReactElement;
