...
import { Friendships } from "../API.js";
...
export declare type FriendshipsUpdateFormProps = React.PropsWithChildren<
  {
    ...
    onSubmit?: (
      fields: FriendshipsUpdateFormInputValues
    ) => FriendshipsUpdateFormInputValues;
...
>;
export default function FriendshipsUpdateForm(
  props: FriendshipsUpdateFormProps
): React.ReactElement;
