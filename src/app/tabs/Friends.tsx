...
import {FriendRequestStatus, Friendships, RelationshipStatus} from "@/API";
                ...
                <div
                    ...
                    <div className="flex flex-col items-center pb-10">
                        <img className="w-24 h-24 mb-3 rounded-full shadow-lg"
                             src={friend.firstUser?.photo ?? "/placeholder_avatar.jpg"}
                             alt="Match friend picture"/>
                        <h5 className="mb-1 text-xl font-medium text-gray-900 dark:text-white">{friend.firstUser?.name}</h5>
                        <span className="text-sm text-gray-500 dark:text-gray-400">{friend.firstUser?.bio}</span>
