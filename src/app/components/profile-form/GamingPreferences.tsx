...
const GamingPreferences: React.FC<GamingPreferencesProps> = ({
  formData,
  handleChange,
  updateGames,
}) => {
            ...
            <div className="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
              ...
              <div className="sm:col-span-4">
                <label
                  ...
                  className="block text-sm font-medium leading-6 text-gray-900"
                >
                  Time availability for gaming sessions
                </label>
                <div className="mt-2">
                  <select
                    onChange={handleChange}
                  ...
                  >
                    ...
                    <option value="(6-12 AM) Weekdays Morning">
                      (6-12 AM) Weekdays Morning
                    </option>
                    <option value="(12-5 PM) Weekdays Afternoon">
                      (12-5 PM) Weekdays Afternoon
                    </option>
                    <option value="(5-9 PM) Weekdays Evening">
                      (5-9 PM) Weekdays Evening
                    </option>
                    <option value="(9-6 AM) Weekdays Night">
                      (9-6 AM) Weekdays Night
                    </option>
                    <option value="(6-12 AM) Weekends Morning">
                      (6-12 AM) Weekends Morning
                    </option>
                    <option value="(12-5 PM) Weekends Afternoon">
                      (12-5 PM) Weekends Afternoon
                    </option>
                    <option value="(5-9 PM) Weekends Evening">
                      (5-9 PM) Weekends Evening
                    </option>
                    <option value="(9-6 AM) Weekends Night">
                      (9-6 AM) Weekends Night
                    </option>
                  </select>
                </div>
              </div>
              <div className="sm:col-span-4">
                <label
                  ...
                  className="block text-sm font-medium leading-6 text-gray-900"
                >
                  Preferred age range of teammates
                </label>
                <div className="mt-2">
                  <select
      ...
      <div className="mt-10 space-y-10">
        <fieldset>
          ...
          <div className="mt-6 space-y-6">
            <div className="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
              <div className="sm:col-span-4">
                ...
                <div className="mt-2">
                  ...
                  >
                    ...
                    <option value="Damage Per Second (DPS)">
              ...
              <div className="sm:col-span-4">
                ...
                <div className="mt-2">
                  ...
                  >
                    <option value="">Select...</option>
                    <option value="Aggressive/Offensive">
                      Aggressive/Offensive
                    </option>
                    <option value="Defensive/Tactical">
                      Defensive/Tactical
                    </option>
                    <option value="Supportive/Team-oriented">
                      Supportive/Team-oriented
                    </option>
                    <option value="Stealthy/Strategic">
                      Stealthy/Strategic
                    </option>
                    <option value="Explorative/Completionist">
                      Explorative/Completionist
                    </option>
                    <option value="Competitive/PVP-focused">
                      Competitive/PVP-focused
                    </option>
            ...
            <p className="block text-sm font-medium leading-6 text-gray-900">
              Flexible in adapting to different strategies or roles?
            </p>
            <div className="mt-6 space-y-6">
              <div className="flex items-center gap-x-3">
                <input
      ...
      <div className="mt-10 space-y-10">
        <fieldset>
          ...
          <div className="mt-6 space-y-6">
            ...
            <p className="block text-sm font-medium leading-6 text-gray-900">
              Level of tolerance for mistakes
            </p>
            ...
            <div className="mt-6 flex gap-x-6">
              ...
              <div className="flex items-center gap-x-3">
                ...
                />
                <label
                  htmlFor="averageCompetitiveness"
                  className="block text-sm font-medium leading-6 text-gray-900"
                >
                  Average
                </label>
