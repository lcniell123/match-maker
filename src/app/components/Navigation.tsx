                    ...
                    <div>
                        ...
                        >
                            ...
                            {friendRequests.length > 0 && (
                                <div
                                    className="absolute inline-flex items-center justify-center w-6 h-6 text-xs font-bold text-white bg-blue-500 border-2 border-white rounded-full -top-2 -end-2"
                                >
                                    ...
                                    {() => (
                                        <div className="flex-auto px-4 py-2 hover:bg-gray-100">
                                            ...
                                            <div className="space-x-2">
                                                <button
                                                    onClick={() => acceptFriendRequest(request.id, request.userId)}
